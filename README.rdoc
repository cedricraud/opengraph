...
_This is a fork of https://github.com/intridea/opengraph, which adds the inference of the title and description based on other tags (pass true for the third argument to enable it)._
